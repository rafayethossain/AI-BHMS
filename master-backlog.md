...
AGENTS.md (workflow guide)
  └── master-backlog.md ← YOU ARE HERE (single backlog)
        ...
        ├── analysis/ (historical GC-vs-BHMS analysis — superseded by Part 2 sequence)
...
## 15. Epic 14: Foundation Requirements (formerly GC Foundation — Sprint 0)

> **Note**: Original planned story titles below (GC-004..GC-007 were later scoped into the fabric app — see Part 2, RQ-015..RQ-018). Current scope/status is authoritative in Part 2.

### RQ-001 — Celery Task Infrastructure (formerly GC-000)

| Field | Value |
|-------|-------|
| **Story ID** | RQ-001 (formerly GC-000) |
...
### RQ-003 — Risk Indicator System (formerly GC-001)

| Field | Value |
|-------|-------|
| **Story ID** | RQ-003 (formerly GC-001) |
...
### RQ-002 — Standardized Notes System (formerly GC-002)

| Field | Value |
|-------|-------|
| **Story ID** | RQ-002 (formerly GC-002) |
...
### RQ-004 — Supplier Pre-Approval Workflow (formerly GC-003)

| Field | Value |
|-------|-------|
| **Story ID** | RQ-004 (formerly GC-003) |
...
### RQ-015 — Fabric Categories & HTS Codes (formerly GC-004)

| Field | Value |
|-------|-------|
| **Story ID** | RQ-015 (formerly GC-004) |
...
### GC-005 — Fabric Supplier & Mill Management (historical — consolidated into RQ-015 fabric app)

| Field | Value |
|-------|-------|
| **Story ID** | GC-005 (historical) |
...
### GC-006 — Fabric Supplier RFQ Workflow (historical — consolidated into RQ-015 fabric app)

| Field | Value |
|-------|-------|
| **Story ID** | GC-006 (historical) |
...
### GC-007 — Fabric Inventory/Booking System (historical — consolidated into RQ-015 fabric app)

| Field | Value |
|-------|-------|
| **Story ID** | GC-007 (historical) |
...
| US-007 | DRF API Foundation | 5 |
| US-008 | Health Check Endpoints | 3 |
| RQ-001 | Celery Task Infrastructure (formerly GC-000) | 3 |
| RQ-003 | Risk Indicator System (formerly GC-001) | 5 |
| RQ-002 | Standardized Notes System (formerly GC-002) | 3 |
| RQ-004 | Supplier Pre-Approval Workflow (formerly GC-003) | 3 |
| **Total** | | **45** |
...
| Story ID | Story | Points |
|----------|-------|--------|
| RQ-015 | Fabric Master Data (formerly GC-004) | 8 |
| RQ-016 | Fabric Tolerance Tables (formerly GC-005) | 5 |
| RQ-017 | Fabric Order — Lab Dip/Bulk (formerly GC-006) | 5 |
| RQ-018 | Fabric Risk & Schedule (formerly GC-007) | 3 |
| **Total** | | **21** |
...
> BHMS is the complete solution. The items below are **BHMS requirements** (formerly framed as "GC gaps").
...
> **RQ-###** is the primary ID; the former **GC-0XX** is kept inline for traceability to tests/migrations/lessons.
...
### RQ ↔ GC Traceability (35 requirements)

| RQ-ID | Former GC | Requirement | Workflow Stage |
|-------|-----------|-------------|----------------|
| RQ-001 | GC-000 | Celery Task Infrastructure | 1 — Foundation & Cross-Cutting |
| RQ-002 | GC-002 | Standardized Notes System | 1 — Foundation & Cross-Cutting |
| RQ-003 | GC-001 | Risk Indicator System | 1 — Foundation & Cross-Cutting |
| RQ-004 | GC-003 | Supplier Pre-Approval | 1 — Foundation & Cross-Cutting |
| RQ-005 | GC-033 | Design Image Management | 2 — Style & Design |
| RQ-006 | GC-034 | Not Sold Analysis | 2 — Style & Design |
| RQ-007 | GC-025 | Sales Confirmation (48h) | 3 — Order Intake (FO & PO) |
| RQ-008 | GC-026 | Quick Lead Time Orders | 3 — Order Intake (FO & PO) |
| RQ-009 | GC-028 | Repeats Management | 3 — Order Intake (FO & PO) |
| RQ-010 | GC-010 | Hit Management / Breakdown | 3 — Order Intake (FO & PO) |
| RQ-011 | GC-011 | Fit Specification System | 4 — Technical / Spec |
| RQ-012 | GC-012 | Fit Spec Copying | 4 — Technical / Spec |
| RQ-013 | GC-031 | Order-Level Costing Enhancements | 5 — Costing |
| RQ-014 | GC-032 | Design Costing (Pattern Options) | 5 — Costing |
| RQ-015 | GC-004 | Fabric Master Data | 6 — Procurement (Fabric & Trims) |
| RQ-016 | GC-005 | Fabric Tolerance Tables | 6 — Procurement (Fabric & Trims) |
| RQ-017 | GC-006 | Fabric Order (Lab Dip/Bulk) | 6 — Procurement (Fabric & Trims) |
| RQ-018 | GC-007 | Fabric Risk & Schedule | 6 — Procurement (Fabric & Trims) |
| RQ-019 | GC-027 | Stock Fabric Management | 6 — Procurement (Fabric & Trims) |
| RQ-020 | GC-017 | Fabric Schedule (Role Handoff) | 6 — Procurement (Fabric & Trims) |
| RQ-021 | GC-008 | Trim/Label Schedule | 6 — Procurement (Fabric & Trims) |
| RQ-022 | GC-009 | Trim/Label Copy From Order | 6 — Procurement (Fabric & Trims) |
| RQ-023 | GC-030 | Fabric Utilization Reports | 6 — Procurement (Fabric & Trims) |
| RQ-024 | GC-013 | Job Request/Queue | 7 — Production & Job Queue |
| RQ-025 | GC-014 | Job Queue Dashboard | 7 — Production & Job Queue |
| RQ-026 | GC-020 | Docket Management | 7 — Production & Job Queue |
| RQ-027 | GC-021 | Final Hit Reconciliation | 7 — Production & Job Queue |
| RQ-028 | GC-019 | Order Manager Dashboard | 7 — Production & Job Queue |
| RQ-029 | GC-015 | Booking Schedule | 8 — Shipment & Logistics |
| RQ-030 | GC-018 | Booking Ref Management | 8 — Shipment & Logistics |
| RQ-031 | GC-022 | Shipping Paperwork Comparison | 8 — Shipment & Logistics |
| RQ-032 | GC-016 | Gold Seal Tracking | 9 — Quality & Compliance |
| RQ-033 | GC-029 | Compliance Audit | 9 — Quality & Compliance |
| RQ-034 | GC-023 | Debit Note System | 10 — Commercial & Finance |
| RQ-035 | GC-024 | Invoice Approval | 10 — Commercial & Finance |

---

### Stage 1: Foundation & Cross-Cutting (RQ-001 → RQ-004) 4/4 ✅ 100%

| Item | Requirement (formerly GC) | Backlog Story | PRD Ref | Status | Tests | Seed Data | Lessons |
|------|---------------------------|---------------|---------|--------|-------|-----------|---------|
| RQ-001 | Celery Task Infrastructure (GC-000) | US-003 | §7.2 Async Processing | ✅ 100% | 5 | N/A | Sprint 2 — Celery app creation |
| RQ-002 | Standardized Notes System (GC-002) | US-015 | §6.2.3 Notes | ✅ 100% | 13 | Notes per FO | Sprint 2 — Note abstract model |
| RQ-003 | Risk Indicator System (GC-001) | US-053 | §6.2.4 Risk Mgmt | ✅ 100% | 9 | 5 risk levels | Sprint 2 — RiskLevel CRUD |
| RQ-004 | Supplier Pre-Approval (GC-003) | US-091 | §3.4 Vendor | ✅ 100% | 5 | Vendor approval | Sprint 2 — Vendor approval fields |
...
| Item | Requirement (formerly GC) | Backlog Story | PRD Ref | Status | Tests | Seed Data | Lessons |
|------|---------------------------|---------------|---------|--------|-------|-----------|---------|
| RQ-005 | Design Image Management (GC-033) | — | §6.1.1 Design | ✅ 100% | 16 + 3 seed | Main/range/detail image per style — child of Style, nested API `/styles/{id}/design_images/`, managed in Style screen | RQ-005 — DesignImage model (Sprint 2 add-on) |
| RQ-006 | Not Sold Analysis (GC-034) | — | §6.1.1 Design | ✅ 100% | 17 + 3 seed | Completed sample job per style; styles with a FileOpening are "sold", rest "not sold" — action `/job-requests/unsold_analysis/` | RQ-006 — analytic action (Sprint 2 add-on) |
...
| Item | Requirement (formerly GC) | Backlog Story | PRD Ref | Status | Tests | Seed Data | Lessons |
|------|---------------------------|---------------|---------|--------|-------|-----------|---------|
| RQ-007 | Sales Confirmation (48h) (GC-025) | — | §5.2 Sales | ✅ 100% | 29 + 3 seed | 5 confirmations (draft/sent ×2 incl. 1 overdue/disputed/accepted) — `SalesConfirmation` in commercial, linked to PO + Buyer | RQ-007 — SalesConfirmation model + 48h Celery auto-accept |
| RQ-008 | Quick Lead Time Orders (GC-026) | — | §5.1.2 Orders | ✅ 100% | 20 + 3 seed | 2 quick lead file openings (1 fully agreed, 1 partial) — `is_quick_lead` + `quick_lead_agreed_by` on FileOpening | RQ-008 — FileOpening quick lead marking + agreement workflow |
| RQ-009 | Repeats Management (GC-028) | — | §5.1.3 Repeats | ✅ 100% | 22 + 3 seed | 2 repeat file openings (1 fully approved by technical+trims, 1 partial) — `original_fn` self-FK + `is_repeat` + `repeat_approved_by` on FileOpening | RQ-009 — FileOpening repeat creation + department approval workflow |
| RQ-010 | Hit Management / Breakdown (GC-010) | — | §6.2.5 Hit Mgmt | ✅ 100% | 16 + 4 seed | Hits per PO colour (boxed/hanging, sea/air) — child of PO, nested API `/purchase-orders/{id}/hits/`, managed in PO screen | Sprint 2.6 — Hit model; Sprint 2.10 — reparented to PO (was PO item) |
...
| Item | Requirement (formerly GC) | Backlog Story | PRD Ref | Status | Tests | Seed Data | Lessons |
|------|---------------------------|---------------|---------|--------|-------|-----------|---------|
| RQ-011 | Fit Specification System (GC-011) | — | §6.2.6 Spec Mgmt | ✅ 100% | 16 + 4 seed | Per-PO specs (dev/1st/2nd/3rd) with one current | Sprint 2.8 — FitSpec model |
| RQ-012 | Fit Spec Copying (GC-012) | — | §6.2.6 Spec Mgmt | ✅ 100% | 14 | copy-from-order action copies ticked spec across orders | Sprint 2.9 — Fit Spec Copying |
...
| Item | Requirement (formerly GC) | Backlog Story | PRD Ref | Status | Tests | Seed Data | Lessons |
|------|---------------------------|---------------|---------|--------|-------|-----------|---------|
| RQ-013 | Order-Level Costing Enhancements (GC-031) | — | §6.2.1 Costing | ✅ 100% | 24 | 8 costings across 5 sheet types (SL/VN/BD/CN/other), 1 live tick, 4 with GBP exchange rate, 5 cost lines each (Fabric/Trims/Labels/Making/Overheads) | RQ-013 — Costing sheet type + live tick + costing lines |
| RQ-014 | Design Costing (Pattern Options) (GC-032) | — | §6.1.2 Design Costing | ✅ 100% | 22 | First 8 POs' costings gain design fields (single-size watermark ×1, patterned striped+match-point, sizes & ratio, confirmed ticks) — `is_single_size`, `size_ratio`, `confirmed`, `is_patterned`/`patterned_fabric_options`, notes, `size_width` on lines | RQ-014 — Design Costing: pattern options + single-size watermark |
...
| Item | Requirement (formerly GC) | Backlog Story | PRD Ref | Status | Tests | Seed Data | Lessons |
|------|---------------------------|---------------|---------|--------|-------|-----------|---------|
| RQ-015 | Fabric Master Data (GC-004) | US-075 | §6.3 Materials | ✅ 100% | 59 (10 models) + 4 seed | 12 categories (depth-2: 3 roots + 9 children), 8 HTS codes linked to categories with duty rates | RQ-015 — Fabric master viewsets + docket reports |
| RQ-016 | Fabric Tolerance Tables (GC-005) | — | §6.3.3 Tolerances | ✅ 100% | 33 + 3 seed | 7 GC bands (Primark/Other/Fur) | RQ-016 — FabricTolerance model + tolerance_for resolver |
| RQ-017 | Fabric Order — Lab Dip/Bulk (GC-006) | — | §6.3.2 Fabric PO | ✅ 100% | 17 | 3 orders (draft/bulk_approved/delivered) | Sprint 2.4 — FabricOrder model |
| RQ-018 | Fabric Risk & Schedule (GC-007) | — | §6.3.4 Fabric Schedule | ✅ 100% | 36 + 3 seed | 3 risk-assigned orders (draft→none, bulk_approved→red w/ notes, delivered→green) — `risk_level` FK + `date_owners` + risk policy chain | RQ-018 — FabricOrder risk FK + schedule owner chain |
| RQ-019 | Stock Fabric Management (GC-027) | — | §6.3.1 Fabric | ✅ 100% | 25 + 3 seed | 2 stock fabric FOs (FO-2025-008 with allocation, FO-2025-009 full balance) — `is_stock_fabric` + `total_meters`/`allocated_meters` + `StockFabricAllocation` ledger | RQ-019 — Stock fabric FN + meter allocation ledger |
| RQ-020 | Fabric Schedule — Role Handoff (GC-017) | — | §6.3.4 Fabric Schedule | ✅ 100% | 28 + 3 seed | 5 handoffs per approved order (sales→merch→planning + lab_dip) — `FabricScheduleHandoff` audit log + auto triggers | RQ-020 — FabricScheduleHandoff + owner chain handoff |
| RQ-021 | Trim/Label Schedule (GC-008) | US-035 (BOM) | §6.3.5 Trims | ✅ 100% | 12 + 6 seed | 55 BOM items (Ordered/Partial/Completed) | Sprint 2.5 — BOMItem trim fields |
| RQ-022 | Trim/Label Copy From Order (GC-009) | — | §6.3.5 Trims | ✅ 100% | 18 + 3 seed | Per-style BOMs with trims support copy-trims demo | Sprint 2.7 — copy-trims service/action |
| RQ-023 | Fabric Utilization Reports (GC-030) | — | §6.3.6 Fabric Reports | ✅ 100% | 33 + 3 seed | 2 docket-stage records (FO-2026-1002/1003 across 2 periods) — `FabricUtilization` (final vs actual rating, excess, efficiency) + monthly/quarterly reports | RQ-023 — FabricUtilization + docket reports |
...
| Item | Requirement (formerly GC) | Backlog Story | PRD Ref | Status | Tests | Seed Data | Lessons |
|------|---------------------------|---------------|---------|--------|-------|-----------|---------|
| RQ-024 | Job Request/Queue (GC-013) | — | §6.2.7 Job Queue | ✅ 100% | 20 | 22 job requests (pattern/sample/3d/mini_marker, priority, status) | Sprint 2.10 — JobRequest model + queue |
| RQ-025 | Job Queue Dashboard (GC-014) | — | §6.2.7 Job Queue | ✅ 100% | 18 | `/job-requests/dashboard/` total/by-status/by-type/by-priority/overdue/due-this-week/unassigned | Sprint 2.10 — dashboard action + UI |
| RQ-026 | Docket Management (GC-020) | — | §6.2.9 Dockets | ✅ 100% | 22 + 3 seed | 4 dockets (DK-2025-001..004; DK-2025-003 final, 265 m unused → over-200 m sales flag) — `Docket` in logistics linked to Shipment + contract price/date raised/delivery + over-200 m sales notification | RQ-026 — Docket + over-200 m sales trigger |
| RQ-027 | Final Hit Reconciliation (GC-021) | — | §6.2.9 Dockets | ✅ 100% | 26 + 3 seed | reconciliations per delivered hit (first 2 debited — 45 units short → over-20-unit debit rule; next 2 reconciled clean; rest pending) — `FinalHitReconciliation` in logistics linked to Shipment/Hit, auto-raised on delivered transition | RQ-027 — Final Hit Reconciliation + &gt;20-unit debit trigger |
| RQ-028 | Order Manager Dashboard (GC-019) | — | §6.2.2 Order Mgr | ✅ 100% | 27 + 3 seed | 2 order-manager demo rows (PO-DEMO-01 overdue open + overdue job → risk/red; PO-DEMO-02 delivered + approved gold seal + clean reconciliation → ok/green) — `order_manager` aggregate action on PurchaseOrderViewSet, read-mostly, no new models | RQ-028 — Order Manager dashboard (aggregate, no new models) |

---

### Stage 8: Shipment & Logistics (RQ-029 → RQ-031) 3/3 ✅

| Item | Requirement (formerly GC) | Backlog Story | PRD Ref | Status | Tests | Seed Data | Lessons |
|------|---------------------------|---------------|---------|--------|-------|-----------|---------|
| RQ-029 | Booking Schedule (GC-015) | — | §6.2.8 Booking | ✅ 100% | 17 + 2 seed | 21 weekly schedule items (live/in_work/delivered, cut qty, garments ready, ex-factory, risk) — `BookingScheduleItem` in logistics, linked to Shipment/Hit | Sprint 4 — BookingScheduleItem model + status flow + risk |
| RQ-030 | Booking Ref Management (GC-018) | — | §6.2.8 Booking | ✅ 100% | 22 + 3 seed | 2 booking-ref demo shipments (SHP-2025-002 filled `BRF-2025-1184` → ok; SHP-2025-004 past ETA no ref → 14-day alert) — `booking_reference` + `booking_ref_required_date` on Shipment, auto-derived ETA−14 days | RQ-030 — Booking Ref + 14-day alert |
| RQ-031 | Shipping Paperwork Comparison (GC-022) | — | §6.2.9 Dockets | ✅ 100% | 20 + 4 seed | 2 dedicated scenario POs — `PO-PC-OVER` (2000 ordered / 2160 shipped / 2400 m docket → 8% over-tolerance, covers order) and `PO-PC-SHORT` (5000 ordered / 5000 shipped / 300 m docket → cannot cover) — `PaperworkComparisonService` in `logistics.services` | RQ-031 — Paperwork Comparison |
...
| Item | Requirement (formerly GC) | Backlog Story | PRD Ref | Status | Tests | Seed Data | Lessons |
|------|---------------------------|---------------|---------|--------|-------|-----------|---------|
| RQ-032 | Gold Seal Tracking (GC-016) | — | §6.4.2 Quality | ✅ 100% | 20 + 3 seed | 1 gold seal per shipment (status rotates pending/sent/approved/rejected) — `GoldSeal` in quality, linked to Shipment | Sprint 4 — GoldSeal model + lifecycle + frontend page |
| RQ-033 | Compliance Audit (GC-029) | — | §6.4.3 Compliance | ✅ 100% | 31 | 16 weekly audits (pass/fail/pending + 3-warning scenario) — `ComplianceAudit` in quality, linked to PO | Sprint 5 — ComplianceAudit model + weekly_overview/export + frontend page |
...
| Item | Requirement (formerly GC) | Backlog Story | PRD Ref | Status | Tests | Seed Data | Lessons |
|------|---------------------------|---------------|---------|--------|-------|-----------|---------|
| RQ-034 | Debit Note System (GC-023) | — | §6.2.10 Debits | ✅ 100% | 34 + 4 seed | 4 debit notes (DN-2025-001 pro forma over-tolerance / 002 issued fabric shortage / 003 paid trims shortage / 004 final-hit shortage linked to a >20-unit-short reconciliation) | RQ-034 — Debit Note lifecycle + compliance workflow |
| RQ-035 | Invoice Approval (GC-024) | — | §6.2.11 Invoices | ✅ 100% | 43 + 5 seed | 4 invoice approvals (IA-2025-001 matching fabric / 002 mismatched trimmings / 003 over-tolerance fabric linked to DN-2025-001 / 004 approved factory invoice signed off by planner) | RQ-035 — Invoice Approval (GC-024) |
...
- GC Manual anchors (§6.4.3, p47): 8 weekly review items; mini-marker efficiency must be above 85%; 3-warning policy — consecutive failing weekly audits → 2 warnings → 3rd = dismissal, capped at 3
...
- GC Manual anchors (§6.2.11 / §17 Invoice Approvals, p44): "Quantity – Date – Price must match the information on GC. Over-tolerance fabric quantities should have debit raised corresponding." (p44) and planners initially sign off the factory invoice then hand over to accounts (p40); auto-approvals with the accounts package are a future enhancement — implemented as the `auto_approval_eligible` flag only
...
- GC Manual anchors: "Booking Ref is managed by logistics. This must be filled in 14 days minimum before the actual date" (L1306) / "never blank from 2 weeks before the delivery date" (L1187). Anchor date = shipment ETA (the delivery/arrival date logistics manages)
...
- Backend: net-new `Docket` model (`logistics` app, TenantModel, migration `0008_docket.py`) — FK `shipment` → `logistics.Shipment` (`related_name="dockets"`) + `docket_number` (unique per tenant, auto `DK-XXXXXXXX` on create) + `contract_price`/`total_fabric_meters`/`unused_fabric_meters` (Decimal) + `date_raised`/`delivery_date` (Date) + `is_final` (bool) + `sales_notified`/`sales_notified_at` + `notes`; property `requires_sales_notification` = `is_final AND unused_fabric_meters > 200` (GC: fabric over 200 m unusable after the final docket must go to sales — Debbie & Palones) + `notify_sales()` method; ordering `-created_at`
...
## RQ-015 Done (formerly GC-004) — closes Stage 6 at 9/9 ✅
...
- Seed: `_seed_fabric_tolerance_data()` — 7 GC bands exactly as the manual: Primark 0.01–2999 ±5% / 3001–4999 ±3% / 5000+ ±2%; Other 0.01–4999 ±5% / 5000–9999 ±3% / 10000+ ±2%; Fur flat ±2%
...
3. [ ] Read `analysis/01-gc-feature-catalog.md` — historical GC reference (requirement intent)
4. [ ] Read `analysis/02-gap-analysis-bhms-vs-gc.md` — historical priority and dependencies
